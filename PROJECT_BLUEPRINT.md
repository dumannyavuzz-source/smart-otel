# PROJECT_BLUEPRINT.md — Smartotel Proje Planı

> Bu belge, Smartotel'in **ne** olduğunu, **kimin için** yapıldığını ve **nasıl** inşa edileceğini anlatır.
...
### 1.1 Tek Cümleyle Smartotel
Smartotel; otel personelinin işini telefondan, QR kodla ve birkaç dokunuşla yapmasını sağlayan,
...
**Satış modeli:** SaaS. Smartotel tek bir sistemdir; her otel kendi hesabıyla, kendi verisiyle kullanır.
...
- Misafir şikayetlerinin **büyük çoğunluğu** Google'a değil, önce Smartotel'e düşsün.
...
### 2.1 Dört Parça
Smartotel dört parçadan oluşur. Üçü insanların dokunduğu ekranlar, biri her şeyi hatırlayan ortak beyindir.
